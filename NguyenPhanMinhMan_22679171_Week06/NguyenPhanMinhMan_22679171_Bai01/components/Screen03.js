  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={{ flexDirection: 'row', margin: 0, padding: 0, width: '100%'}}>
        ...
        />
        <Text style={{flex: 1, paddingTop: 15}}>Dien thoai Vsmart Joy 3 {'\n'}Hang chinh hang{'\n'}Mau: <Text style={{fontWeight: 'bold'}}>do</Text>{'\n'}Cung cap boi <Text style={{fontWeight: 'bold'}}>Tiki Tradding</Text>{'\n'}<Text style={{fontWeight: 'bold'}}>1.790.000 đ</Text></Text>
      ...
      <TouchableOpacity style={styles.btnComplete} onPress={() =>navigation.navigate('Screen04')}>XONG</TouchableOpacity>
    </SafeAreaView>
  );
}
